        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-8">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex gap-4">
                  <div className="bg-zenbuzz-purple/10 rounded-full p-3 h-fit">{item.icon}</div>
                  <div>
              ...
              <div className="mt-4">
                ...
                <div className="flex gap-4">
                  <a href="#" className="bg-gray-200 hover:bg-zenbuzz-purple hover:text-white transition-colors p-2 rounded-full">
          ...
          <div className="lg:col-span-2 bg-white p-8 rounded-lg shadow-md">
            <form onSubmit={handleSubmit}>
              ...
              <Button 
                type="submit" 
                className="bg-zenbuzz-purple hover:bg-zenbuzz-darkPurple w-full"
